...
@section('title','后台')
@section('content')
  <header class="Hui-header cl"><a class="Hui-logo l" title="小海番剧" href="/">小海番剧</a><span class="Hui-subtitle l">后台</span>
  ...
  <aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-product">
        ...
        <dd>
          <ul>
            <li><a _href="{{asset('/admin/video')}}" data-title="视频管理" href="javascript:void(0)">视频管理</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-order">
  ...
  <section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
      <div class="show_iframe">
        ...
        <iframe scrolling="yes" frameborder="0" src="{{asset('/pc')}}"></iframe>
      </div>
    </div>
  </section>
@endsection