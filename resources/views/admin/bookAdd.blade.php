  ...
  <form action="" method="post" class="form form-horizontal" id="form-member-add">
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="member-name" name="book_title" datatype="*2-16" nullmsg="本子名称不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5 skin-minimal">
        <div class="radio-box">
          <input class="lifan-video-checkBox"  type="checkbox"  value="动漫画集" datatype="*" nullmsg="是否发布！">
          <label>动漫画集</label>
        </div>
        <div class="radio-box">
          <input class="lifan-video-checkBox"  type="checkbox"  value="杂志画集" >
          <label>杂志画集</label>
        </div>
        <div class="radio-box">
          <input class="lifan-video-checkBox"  type="checkbox"  value="网站推荐" >
          <label>网站推荐</label>
        </div>

        <div class="radio-box">
          <input class="lifan-video-checkBox"  type="checkbox"  value="游戏CG" >
          <label>游戏CG</label>
        </div>

        <div class="radio-box">
          <input class="lifan-video-checkBox"  type="checkbox"  value="个人动画" >
          <label>个人动画</label>
        </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea id="book-content" name="" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入5个字符" datatype="*5-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"></textarea>
