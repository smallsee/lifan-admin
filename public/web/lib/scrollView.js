    ...
    ScrollXiaohai.prototype = {
      ...
      _pageIcon : function(){
        ...
        if (me.settings.icon.position == 'start'){
          ...
          paddingLeft = me.horizontal ? (me.settings.width - me.settings.icon.iconWidth*me.pagesCount -  me.settings.icon.marginRight*(me.pagesCount)) -10 :
      ...
      _btnIcon : function(){
        ...
        me.prevBox = $('<div class='+prevBoxClass+'>').css({
          ...
          top: me.horizontal ? 0 : me.btn.left ,
        ...
        me.nextBox = $('<div class='+nextBoxClass+'>').css({
          ...
          height:me.horizontal ? me.settings.height : me.btn.width,
          backgroundColor: me.btn.color,
          top: me.horizontal ? 0 : me.settings.height - me.btn.width-me.btn.left,
